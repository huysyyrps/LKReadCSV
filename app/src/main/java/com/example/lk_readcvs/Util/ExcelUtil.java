        ...
        if (objList != null && objList.size() > 0) {
            ...
            try {
                ...
                for (int j = 0; j < objList.size(); j++) {
                    ...
                    list.add(dataBean.getOffACVoltage());
                    list.add(dataBean.getOnDirectCurrent());
                    list.add(dataBean.getOnDirectVoltage());
                    list.add(dataBean.getOnACCurrent());
                    list.add(dataBean.getOnACVoltage());
